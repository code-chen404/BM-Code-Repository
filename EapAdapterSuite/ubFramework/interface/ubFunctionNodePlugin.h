...
#define	kNodeInforTitle			"kNodeInforTitle"	
#define	kNodeInforType			"kNodeInforType"
#define	kNodeInforIcon			"kNodeInforIcon"
#define	kNodeInforGroup			"kNodeInforGroup"	
#define	kNodeInforTooltip		"kNodeInforTooltip"

class ubFunctionNodePlugin
{
public:
	...
	*/
	...
	virtual QList<QVariantMap> FunctionNodeList() = 0;
...
#define ubFunctionNodePlugin_IID  "com.Bomming.interface.ubFunctionNodeInterface"
Q_DECLARE_INTERFACE(ubFunctionNodePlugin, ubFunctionNodePlugin_IID)